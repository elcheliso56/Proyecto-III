...
function crearDT() {
    ...
    if (!$.fn.DataTable.isDataTable("#tablasalidas")) {
        $("#tablasalidas").DataTable({
            language: {
                ...
                zeroRecords: "No se encontraron salidas de productos",
                info: "Página _PAGE_ de _PAGES_",
                infoEmpty: "No hay salidas registradas",
    ...
    $(window).resize(function() {
        $('#tablasalidas').DataTable().columns.adjust().draw();
    });
}
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            try {
                ...
                else if(lee.resultado=='salida'){   

                   console.log(lee.mensaje);             
                   Swal.fire({
                    title: "¡Incluido!",
                    text: "La salida ha sido incluida con éxito.",
                    icon: "success"
                });
                    $("#modal1").modal("hide"); // Oculta el modal
...
function validarenvio() {
    if (existecliente() == true) {
        if (verificaproductos()) {
            ...
            Swal.fire({
                title: "Error",
                text: "Debe agregar algún producto a la salida",
                icon: "error"
            });
            return false;
        }
