...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 03:49:34
...
(9, 'Tarjeta de Crédito', 'tarjeta', -2000.00, '9876543210', 'Visa', 'USD', 1, '2025-05-01 04:00:00'),
...
--
ALTER TABLE `citas`
  MODIFY `id_cita` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
