...
?> 
		<div class="container"> 
			<h1>Gestionar Empleados</h1> <!-- Título principal de la página -->
			<div class="container">
				<div class="row mt-1 justify-content-center">
					<div class="col-md-2 text-center">
						<!-- Botón para registrar un nuevo empleado -->
						<button type="button" class="btn-sm btn-success w-75 small-width" id="incluir" title="Registrar Empleado"><i class="bi bi-plus-square"></i></button>		    	
					</div>				
				</div>
			</div>
		...
		<div class="modal fade" tabindex="-1" role="dialog"  id="modal1">
			<div class="modal-dialog modal-lg" role="document" id="lm">
				<div class="modal-header" id="hm">
					<h5 class="modal-title"><i class="zmdi zmdi-accounts"></i> Empleados</h5>
				</div>
