...
?>
<div class="container"> 
	<h1> Gestionar Salidas de productos</h1>
	<p  style="text-align:justify;">"En la sección de Salidas registrarás todas las salidas de productos del inventario. Selecciona el cliente, los productos vendidos y sus cantidades. El sistema actualizará automáticamente el stock disponible. Un registro preciso de las salidas te ayudará a mantener el control de tu inventario."</p> 
	<div class="container">
		<div class="row mt-1 justify-content-center">
			<div class="col-md-2 text-center">
				<button type="button" class="btn-sm btn-success w-75 small-width" id="incluir" title="Registrar Salida"><i class="bi bi-plus-square"></i></button><!-- Botón para registrar una nueva salidas -->
			</div>				
		</div>
	</div>
	<!-- Tabla para mostrar las salidas -->
	<div class="container">
		<div class="table-responsive" id="tt">
			<table class="table table-striped table-hover table-center" id="tablasalidas">
				<thead class="tableh">
					<tr>
...
<!-- Modal para agregar salidas de productos -->
<div class="modal fade" tabindex="-1" role="dialog"  id="modal1">
	<div class=" modal-dialog modal-xl" role="document" id="lm">
		<div class="modal-header" id="hm">
			<h5 class="modal-title"><i class="bi bi-cart-dash-fill"></i> Salida de Productos</h5>
		</div>
		<div class="modal-content">
			<div class="container" id="mtm"> 
				...
				<div class="modal-footer  justify-content-between">
					...
					<button type="button" class="btn btn-success bi bi-check-square" id="salida" name="salida">INCLUIR</button>
				</div>
			</div>	
		</form>
	</div> 
