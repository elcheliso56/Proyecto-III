                    ...
                    <div class="container">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="int" id="cedula" name="cedula"  title="El cedula no puede ser modificado..." placeholder="Cedula es obligatorio"/>
                                <span id="scedula"></span>
                            </div>
                             <div class="col-md-6">
                                <label for="telefono">Teléfono</label>
                                <input class="form-control" type="text" id="telefono" name="telefono" placeholder="Ejemplo: 04123456789" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" id="Apellido"  name="Apellido"placeholder="Apellido obligatorio" />
