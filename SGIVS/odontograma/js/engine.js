...
Engine.prototype.init = function () {
    ...
    this.clear.textBox.text = "Resetear";
...
Engine.prototype.print = function () {
    ...
    windowContent += '<title>Odontograma</title>';
    windowContent += '</head>';
    windowContent += '<body >';
...
Engine.prototype.createMenu = function () {
    ...
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Corona (Tmp)", 3);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Desaparecido", 4);
    posX = posX + xSeparator;
    ...
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "prot remov", 12);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Deriva", 13);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Rotacion", 14);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Fusion", 15);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Res Raiz", 16);

    posY = posY + buttonHeight + ySeparator;
    posX = startX;

    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Erupcion", 24);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Transposicion", 25);
    posX = posX + xSeparator;
    ...
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Prostesis", 29);
    posX = posX + xSeparator;
    ...
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Ort. fija", 32);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Prot. Fija", 34);
    posX = posX + xSeparator;
    ...
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Discromico", 22);
    ...
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Semi inpac", 30);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Intrucion", 20);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Edentulismo", 31);
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Ectopico", 21);
    posX = posX + xSeparator;
    ...
    posX = posX + xSeparator;
    this.createMenuButton(posX, posY, buttonWidth, buttonHeight, "Extrucion", 9);
    posX = posX + xSeparator;
